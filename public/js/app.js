...
document.addEventListener('DOMContentLoaded', async () => {
	...
	const setModalData = (obj) => {
		...
		const listItems = paragraphs.map((paragraph) => {
		  ...
		  /* eslint-disable */console.log(...oo_oo(`3841036448_0`,'🪲 file: app >>> row: 155 >>>', listItems.join('')))
